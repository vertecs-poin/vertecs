...
export default class Accessor extends GLTFObject {
  ...
  public getDataAsFloat32Array(): Float32Array {
    const arrayBuffer = this.#bufferView.getArrayBuffer(this.getByteLength(), this.#byteOffset);
  ...
  public getData(): ArrayBuffer {
    return this.#bufferView.getArrayBuffer(this.getByteLength(), this.#byteOffset);
  }
  ...
  public getByteLength(): number {
    return this.#count * this.getComponentTypeSizeInBytes() * this.getTypeSizeInBytes();
  }
  ...
  public getTypeSizeInBytes(): number {
    switch (this.#type) {
      case "SCALAR": {
        return 1;
      }
  ...
  public set byteStride(value: number) {
    this.#bufferView.byteStride = value;
  }
